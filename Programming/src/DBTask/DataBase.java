...
public class DataBase {
    public static void main(String[] args) throws SQLException {
        ...
        statement.executeQuery("create table hello(id serial primary key, name text, message text)");
        statement.executeQuery("INSERT INTO hello( name, message) VALUES ('name_1', 'message_1')");
